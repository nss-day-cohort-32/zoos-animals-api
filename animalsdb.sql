...
VALUES ('Butter', 'Northwest African Cheetah', 'Carnivore', 4, 2);

INSERT INTO Animals ([Name], Species, EatingHabit, Legs, ZooId)
VALUES ('Coconut', 'Northwest African Cheetah', 'Carnivore', 4, 2);

INSERT INTO Animals ([Name], Species, EatingHabit, Legs, ZooId)
VALUES ('Peach', 'Macaroni Penguin', 'Herbivore', 2, 1);

INSERT INTO Animals ([Name], Species, EatingHabit, Legs, ZooId)
VALUES ('Marshmallow', 'Macaroni Penguin', 'Herbivore', 2, 1);

INSERT INTO Animals ([Name], Species, EatingHabit, Legs, ZooId)
VALUES ('Tutti Frutti', 'Spinner Dolphin', 'Carnivore', 0, 2);

INSERT INTO Animals ([Name], Species, EatingHabit, Legs, ZooId)
VALUES ('Bubble Gum', 'Spinner Dolphin', 'Carnivore', 0, 2);

INSERT INTO Animals ([Name], Species, EatingHabit, Legs, ZooId)
VALUES ('Lemon Drop', 'Sea Otter', 'Omnivore', 4, 1);

INSERT INTO Animals ([Name], Species, EatingHabit, Legs, ZooId)
VALUES ('Margarita', 'Sea Otter', 'Omnivore', 4, 1);